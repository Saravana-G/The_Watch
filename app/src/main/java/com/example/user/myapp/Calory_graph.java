...
public class Calory_graph extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.calorygraph);
    ...
    public void calory_calender_click(View view) {
        showDialog(999);
    }
...
*/
        ...
        LinearLayout chartContainer = (LinearLayout) findViewById(R.id.drawgraph);
        chartContainer.removeAllViews();
       // mChart=ChartFactory.getLineChartView(Calory_graph.this,dataset,multiRenderer);
        mChart = ChartFactory.getBarChartView(Calory_graph.this, dataset, multiRenderer, Type.DEFAULT);
